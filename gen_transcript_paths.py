...
def create_vid_paths_csv(vid_base_path, feature_out_base_path):
    ...
    # Create the csv file
    csv_file_path = os.path.join(feature_out_base_path, 'vid_transcript_paths.csv')
...
if __name__ == '__main__':
    create_vid_paths_csv("/home/admin-guest/Documents/multimodal-ml/Social_IQ_2_Data/siq2_clean/video/",
                 "/home/admin-guest/Documents/multimodal-ml/iqui/FrozenBiLM_clip/datasets/SIQ2/speaking_features")
