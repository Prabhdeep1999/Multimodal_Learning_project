...
# Finetune siq2
python -m torch.distributed.launch --nproc_per_node 2 --use_env mc.py --combine_datasets siq2 --combine_datasets_val siq2 --save_dir=ftsiq2_test --lr=5e-5 --schedule=linear_with_warmup --load=models/frozenbilm.pth --ds_factor_ff=8 --ds_factor_attn=8 --suffix="." --batch_size=2 --batch_size_val=8 --max_tokens=256 --epochs=20 


# Finetune siq2 with gpu1 and turns
CUDA_VISIBLE_DEVICES=1 python mc_siq2.py --combine_datasets siq2 --combine_datasets_val siq2 --save_dir=ftsiq2_turns --lr=5e-5 --schedule=linear_with_warmup --load=models/frozenbilm.pth --ds_factor_ff=8 --ds_factor_attn=8 --suffix="." --batch_size=2 --batch_size_val=8 --max_tokens=256 --epochs=20 --siq_speaking_turns_path=datasets/SIQ2/turn_information.pkl 2>&1 | tee ftsiq2_turns_transcripts/output.log

# Finetune siq2 with both gpus and turns
nohup python -m torch.distributed.launch --nproc_per_node 2 --use_env mc_siq2.py --combine_datasets siq2 --combine_datasets_val siq2 --save_dir=ftsiq2_turns_new --lr=5e-5 --schedule=linear_with_warmup --load=models/frozenbilm.pth --ds_factor_ff=8 --ds_factor_attn=8 --suffix="." --batch_size=2 --batch_size_val=8 --max_tokens=256 --epochs=20 --siq_speaking_turns_path=datasets/SIQ2/turn_information.pkl --use_speaking_turns_sampling True > ftsiq2_turns_new/output_print.log 2>&1 &

# Finetune siq2 with gpu0 and turns_video_transcripts and equi-sampling
nohup sh -c 'CUDA_VISIBLE_DEVICES=0 python mc_siq2.py --combine_datasets siq2 --combine_datasets_val siq2 --save_dir=ftsiq2_turns_transcripts_nosampling --lr=5e-5 --schedule=linear_with_warmup --load=models/frozenbilm.pth --ds_factor_ff=8 --ds_factor_attn=8 --suffix="." --batch_size=2 --batch_size_val=8 --max_tokens=256 --epochs=40 --siq_speaking_turns_path=datasets/SIQ2/turn_information.pkl --use_speaking_turns_sampling False --features_dim 768 --siq_features_path=datasets/SIQ2/clipvitl14_vid_subs_768.pth' > ftsiq2_turns_transcripts_nosampling/output_print.log 2>&1 &

# Finetune siq2 with gpu1 and turns_video_transcripts and turns sampling
nohup sh -c 'CUDA_VISIBLE_DEVICES=1 python mc_siq2.py --combine_datasets siq2 --combine_datasets_val siq2 --save_dir=ftsiq2_turns_transcripts_variational --lr=5e-5 --schedule=linear_with_warmup --load=models/frozenbilm.pth --ds_factor_ff=8 --ds_factor_attn=8 --suffix="." --batch_size=2 --batch_size_val=8 --max_tokens=256 --epochs=60 --siq_speaking_turns_path=datasets/SIQ2/turn_information.pkl --use_speaking_turns_sampling True --features_dim 768 --siq_features_path=datasets/SIQ2/clipvitl14_vid_subs_768.pth' > ftsiq2_turns_transcripts_variational/output_print.log 2>&1 &

# Finetune siq2 both gpu's, turn_video_transcripts and turn equi sampling
nohup sh -c 'python -m torch.distributed.launch --nproc_per_node 2 --use_env mc_siq2.py --combine_datasets siq2 --combine_datasets_val siq2 --save_dir=ftsiq2_turns_transcripts_nosampling --lr=5e-5 --schedule=linear_with_warmup --load=models/frozenbilm.pth --ds_factor_ff=8 --ds_factor_attn=8 --suffix="." --batch_size=8 --batch_size_val=8 --max_tokens=256 --epochs=60 --siq_speaking_turns_path=datasets/SIQ2/turn_information.pkl --use_speaking_turns_sampling False --features_dim 768 --siq_features_path=datasets/SIQ2/clipvitl14_vid_subs_768.pth' > ftsiq2_turns_transcripts_nosampling/output_print.log 2>&1 &

# Finetune siq2 both gputs, turn_video_transcripts and turn sampling
nohup sh -c 'python -m torch.distributed.launch --nproc_per_node 2 --use_env mc_siq2.py --combine_datasets siq2 --combine_datasets_val siq2 --save_dir=ftsiq2_turns_transcripts_variational --lr=5e-5 --schedule=linear_with_warmup --load=models/frozenbilm.pth --ds_factor_ff=8 --ds_factor_attn=8 --suffix="." --batch_size=8 --batch_size_val=8 --max_tokens=256 --epochs=60 --siq_speaking_turns_path=datasets/SIQ2/turn_information.pkl --use_speaking_turns_sampling True --features_dim 768 --siq_features_path=datasets/SIQ2/clipvitl14_vid_subs_768.pth' > ftsiq2_turns_transcripts_variational/output_print.log 2>&1 &


# Finetune siq2 both gpu's, turn_video_transcripts and turn equi sampling new
nohup sh -c 'python -m torch.distributed.launch --nproc_per_node 2 --use_env mc_siq2.py --combine_datasets siq2 --combine_datasets_val siq2 --save_dir=ftsiq2_turns_transcripts_nosampling_new --lr=8e-5 --schedule=linear_with_warmup --load=models/frozenbilm.pth --ds_factor_ff=8 --ds_factor_attn=8 --suffix="." --batch_size=8 --batch_size_val=8 --max_tokens=256 --epochs=40 --siq_speaking_turns_path=datasets/SIQ2/turn_information.pkl --use_speaking_turns_sampling False --siq_features_path=datasets/SIQ2/clipvitl14_vid_subs_768.pth' > ftsiq2_turns_transcripts_nosampling_new/output_print.log 2>&1 &
