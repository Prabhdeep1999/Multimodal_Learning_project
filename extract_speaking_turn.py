...
for video in data_speaking_turns:
    # /home/admin-guest/Documents/multimodal-ml/iqui/FrozenBiLM_clip/datasets/SIQ2/transcripts/vtt
    try :
        transcript = parse_vtt(f'/home/admin-guest/Documents/multimodal-ml/Social_IQ_2_Data/siq2_clean/transcript/{video}.vtt')
        # transcript = parse_vtt(f'/home/admin-guest/Documents/multimodal-ml/iqui/FrozenBiLM_clip/datasets/SIQ2/transcripts/vtt/{video}.vtt')
